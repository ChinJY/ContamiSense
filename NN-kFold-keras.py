...
#run settings
training_cont = 5
x_start = 11 #starting feature column
x_end = 15 #ending feature column
...
# for i in range(1):
    ...
    model = KerasClassifier(build_fn=create_model, verbose=0, activation='relu', batch_size=50, epochs=100, layers=range(15,45,15))
    ...
    layers=range(15,45,15)
    # activations = ['sigmoid','relu']
    p_grid = dict(layers=layers, epochs=[30])
